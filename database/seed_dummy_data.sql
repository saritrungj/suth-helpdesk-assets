...
-- รันไฟล์นี้หลังจากรัน schema_v3_normalized.sql เรียบร้อยแล้ว
-- ==============================================================================
...
(1, 'ชั้น 1'), (2, 'ชั้น 2'), (3, 'ชั้น 3'), (4, 'ชั้น 4');

INSERT INTO division (id, name) VALUES 
(1, 'ฝ่ายบริหารงานทั่วไป'), (2, 'ฝ่ายการแพทย์'), (3, 'ฝ่ายการพยาบาล');

INSERT INTO department (id, name) VALUES 
(1, 'แผนกการเงินและบัญชี'), (2, 'แผนกทรัพยากรบุคคล'), (3, 'แผนกอายุรกรรม'), 
(4, 'แผนกศัลยกรรม'), (5, 'แผนกฉุกเฉิน');
...
(2, 'SN-CN-002', 2, 'imageCLASS LBP6030', 1, 3, 1, 2, 1, NULL, 'active'),       -- แผนก HR ใช้ราคาตามสัญญา (0.34)
(3, 'SN-EP-003', 3, 'EcoTank L3250', 2, 1, 2, 3, 1, 1.50, 'active'),            -- แผนกอายุรกรรม เป็นปริ้นสี (ราคาพิเศษ 1.50)
(4, 'SN-BR-004', 4, 'HL-L2370DN', 2, 2, 3, 4, 1, NULL, 'repair'),               -- แผนกศัลยกรรม (เครื่องส่งซ่อม)
(5, 'SN-HP-005', 1, 'LaserJet Enterprise', 3, 1, 2, 5, 2, NULL, 'retired');     -- แผนกฉุกเฉิน (เครื่องรุ่นเก่า แทงจำหน่ายแล้ว)

-- 5. เติมข้อมูลยอดการพิมพ์ (ใบเสร็จ/บิลค่าขนม) พร้อมแช่แข็งราคา (snapshot_price)
-- จำลองยอด 3 เดือน: มกราคม (2025-01), กุมภาพันธ์ (2025-02), มีนาคม (2025-03)
INSERT INTO print_transactions (device_id, month, pages, snapshot_price) VALUES 
-- เดือน มกราคม
(1, '2025-01', 5200, 0.34),
(2, '2025-01', 1500, 0.34),
(3, '2025-01', 800, 1.50),  -- ปริ้นสี ราคา 1.50
(4, '2025-01', 3200, 0.34),
(5, '2025-01', 4100, 0.40), -- เครื่องเก่าใช้สัญญาเก่าราคา 0.40
...
(2, '2025-03', 1800, 0.34),
(3, '2025-03', 1100, 1.50),
(4, '2025-03', 0, 0.34); -- ซ่อมอยู่ ยอดเป็น 0

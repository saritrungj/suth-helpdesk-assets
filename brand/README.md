...
> **ไฟล์ในโฟลเดอร์นี้เป็นของรุ่นก่อน** ต้นฉบับและวิธีสร้าง asset ที่เว็บใช้อยู่จริงตอนนี้อยู่ที่
> [`docs/assets/brand/README.md`](../docs/assets/brand/README.md) — คำสั่ง ffmpeg ด้านล่างสร้างไฟล์ชุดเก่า
> ที่ไม่ได้ถูกอ้างในโค้ดแล้ว เก็บไว้เป็นบันทึกที่มาเท่านั้น

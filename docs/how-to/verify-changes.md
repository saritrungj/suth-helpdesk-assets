...
`verify:db` ยังอ่านรายงาน JSON ของ Playwright แล้วล้มถ้ามีเคส `skipped` หรือไม่มีเคสผ่าน
เพื่อไม่ให้เงื่อนไขข้อมูลใน seed ข้าม regression สำคัญแบบเงียบๆ รายงาน HTML ช่วยระบุชื่อเคส
ที่ข้ามได้ ถ้าชุดนี้แดงเพราะ seed ไม่ครอบ ให้เพิ่มข้อมูลตัวอย่างที่ถูกต้องหรือแก้ test ตาม

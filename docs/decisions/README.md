...
| [0036](0036-stock-style-charts.md) | กราฟแบบแอปหุ้นด้วย Lightweight Charts และหน้าเปรียบเทียบแบบรายการหุ้น | Accepted |
| [0037](0037-meter-cycle-and-replacements.md) | เดือนที่ต้องกรอกยอดตามรอบมิเตอร์ของสัญญา และการเปลี่ยนเครื่องจากรายงานของผู้ให้เช่า | Accepted |

...
- ราคาของแต่ละเดือนมาจากช่วงการคิดเงินที่มีผลในเดือนนั้น (`device_contract_history`) ไม่ใช่ราคาปัจจุบันของเครื่อง: ราคาเฉพาะเครื่องของช่วงนั้นก่อน แล้วจึงราคาของสัญญาที่ยืนยันแล้วและครอบคลุมเดือนนั้น — ขั้นตอนเต็มอยู่ที่ [ADR-0019](../decisions/0019-effective-pricing-history.md)
- หาราคาไม่ได้คือ `NULL` = "ยังยืนยันราคาไม่ได้" **ไม่ใช่ศูนย์บาท** ไม่ถูกนับในยอดเงินรวม และทุกยอดเงินต้องแสดงจำนวนรายการที่ยังยืนยันราคาไม่ได้คู่กัน
- ค่าใช้จ่ายเท่ากับจำนวนหน้าสุทธิคูณราคาที่มีผล ปัดเป็นสตางค์ต่อเครื่องต่อเดือนก่อนรวม

...
| ผู้ตรวจดูค่าใช้จ่ายและรายงาน | ยอดรายมิเตอร์รวมเป็นยอดตามใบแจ้งหนี้ทุกสตางค์; เดือนที่ไม่มีข้อมูลไม่กลายเป็นศูนย์; รายงานย้อนหลังใช้ที่ตั้งตามเดือน | [ADR-0017](../decisions/0017-two-percent-page-deduction.md), [ADR-0022](../decisions/0022-round-at-invoice-line-and-allocate.md), [คู่มือรายงาน](../how-to/use-report-workflow.md) | `packages/domain/money.test.js`, `apps/web/e2e/report-workflow.spec.js` ในชุด DB และ `print-comparison.spec.js` แบบ fixture; ชุด DB ต้องรันจริงก่อน merge งานเงิน/รายงาน |

...
รอบล่าสุดปรับเป็นแถบสรุปพื้นเดียวกับการ์ดอื่นในธีม กราฟกว้าง การกดเจาะรายละเอียด และการส่งออกภาพสรุปตามที่ผู้ใช้เลือก ดูเหตุผล ขอบเขตข้อมูล และแหล่งอ้างอิงที่ [หน้าภาพรวมการพิมพ์](executive-dashboard.md) การยอมรับหน้าตาจากผู้ใช้ยังเปิดอยู่
...
### ตัวกรองแถวเดียวครบทุกหน้าที่มีตาราง (16 กันยายน 2026)

หน้ารายงานสรุปกับหน้าเปรียบเทียบตกสำรวจจากรอบ #51 ยังใช้การ์ดตัวกรองก้อนใหญ่อยู่
ขณะที่หน้าทะเบียน บันทึกยอด และค่าใช้จ่ายย้ายไปใช้แถบเดียวไปแล้ว ระบบเดียวจึงมี
สองแบบแผน (#90)

วัดจากหน้าจอจริงที่ 1440×900 พร้อมข้อมูลเต็ม

| หน้า | ก่อน | หลัง |
|---|---|---|
| รายงานสรุป | การ์ด 420px · เห็น 4 แถว · ช่องค้นหาสองช่อง | แถบเดียว ~56px · เห็น 12 แถว · ช่องค้นหาช่องเดียว |
| เปรียบเทียบ | การ์ด 290px · บทสรุปและตารางอยู่ใต้เส้นพับทั้งหมด | แถบเดียว · บทสรุปและตารางอยู่เหนือเส้นพับ |

ทั้งสองหน้าใช้ `ui/UiFilterBar.vue` ตัวเดียวกับหน้าทะเบียน และย้ายเครื่องมือตาราง
(ขยาย/คอลัมน์/Excel) มาต่อท้ายแถวเดียวกันผ่าน `tools-target` ตามที่ Primer DataTable
และ NN/g (Applying filters) ระบุไว้ และบันทึกไว้ในตารางอ้างอิงด้านบนแล้ว

...
| สิ่งที่นำมาใช้ | แหล่ง | อยู่ที่ |
|---|---|---|
| ถือว่าข้อมูลขาเข้าของเครื่องมือเชื่อไม่ได้ เพราะมาจากโมเดล ไม่ใช่จากผู้ใช้ | [NSA/CISA — MCP Security Design](https://media.defense.gov/2026/Jun/02/2003943289/-1/-1/0/CSI_MCP_SECURITY.PDF) | [ADR-0011](../decisions/0011-read-only-mcp-server.md) — เป็นเหตุผลที่ไม่มีเครื่องมือเขียนข้อมูลเลย |
| หนึ่งเซิร์ฟเวอร์ = หนึ่งขอบเขตสิทธิ์ที่ชัดเจน | [MCP Best Practice](https://mcp-best-practice.github.io/mcp-best-practice/best-practice/) | `apps/mcp/api-client.js` — เรียกผ่าน HTTP API เดิม ไม่ต่อฐานข้อมูลตรง |
| เริ่มจากงานเดียว ไม่เปิดทุกอย่างพร้อมกัน | เดียวกัน | เครื่องมือ 5 ตัวที่ตอบคำถามที่คนถามจริง ไม่ใช่ CRUD ครบทุกตาราง |
...
และเชื่อถือได้มากกว่า — ความต้องการ "ถามเป็นภาษาพูด" ถูกตอบด้วยเซิร์ฟเวอร์ MCP แทน
ซึ่งอยู่นอกหน้าเว็บและไม่เพิ่มความเสี่ยงให้ตัวเลขในรายงาน
